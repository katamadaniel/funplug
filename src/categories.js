...
export const categories = [
    { name: 'Music', path: '/category/music', image: process.env.PUBLIC_URL + '/images/music.jpg' },
    { name: 'Art', path: '/category/art', image: process.env.PUBLIC_URL + '/images/art.jpg' },
    { name: 'Games', path: '/category/games', image: process.env.PUBLIC_URL + '/images/games.jpg' },
    { name: 'Movies', path: '/category/movies', image: process.env.PUBLIC_URL + '/images/movies.jpg' },
